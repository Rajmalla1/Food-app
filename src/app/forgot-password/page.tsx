...
<h1 className='text-white font-bold text-3xl xl:text-3xl z-10 text-center md:text-center'>Lost your Flavor? </h1>
<h1 className='text-white font-bold text-3xl z-10 text-center md:text-center'>Let's Get it Back on Track!</h1>
</div>
<Image
...
<div className='w-full lg:w-1/2 h-full flex flex-col p-10 text-white items-center lg:items-start lg:pt-10 lg:ml-10 justify-center bg-white'>
...
<h2 className='text-slate-600 pt-4 text-base sm:text:lg md:text-3xl font-bold'>Recover Password</h2>
<p className='text-slate-500 text-sm sm:text-base md:text-base pt-2'>Request an Email reset link</p>
...
<p className='text-slate-500 text-xs md:text-base mt-2'>Don’t have an account?
<Link className='text-green-500 text-sm md:text-base font-semibold ml-2 hover:text-green-600' href={'/signup'}>Sign Up</Link>
</p>
...
<div className='flex flex-row sm:flex-row items-center justify-center lg:justify-start sm:justify-center mt-4 md:pt-10 md:-ml-2 xl:ml-0 md:items-center flex-wrap md:flex-nowrap md:mt-auto lg:w-3/4'>
          <h1 className='text-slate-500 text-xs md:text-sm md:mr-1 lg:mr-2 cursor-pointer hover:underline font-bold' onClick={() => {onforgot}}>Having issue?</h1>
