    ...
    return (
        <div className="min-h-screen flex items-center justify-center">
            <div className="max-w-screen-lg w-full px-4 sm:px-8 md:px-16">
                ...
                <p className="text-xs sm:text-base  pb-7 pt-4 mb-6 text-slate-600">We&apos;re currently undergoing
                    maintenance to improve your experience. <br/> <span> Please bear with us while we work to make things better.</span>
                </p>
                <CustomButton
