  ...
  return (
    <section className="w-full h-screen flex flex-col lg:flex-row">
      <div className="hidden lg:block relative w-full lg:w-1/2 h-96 lg:h-full overflow-hidden">
        <div
          className="absolute top-[45%] left-[30%] sm:left-[30%] lg:left-[20%] xl:left-[20%] 2xl:left-[25%] 3xl:left-[30%] flex flex-col">
          <h1 className="text-white font-bold text-base md:text-xl lg:text-2xl xl:text-3xl z-10 text-center">Welcome
            Back! Let's Savor the</h1>
          <h1 className="text-white font-bold text-base md:text-xl lg:text-2xl xl:text-3xl z-10 text-center">the Flavor
            Together!</h1>
        </div>
        <Image
      ...
      <div
        className="w-full lg:w-1/2 h-full flex flex-col p-10 text-white items-center lg:items-start lg:pt-10 lg:ml-10 justify-center">
        ...
        <p className="text-slate-600 pt-4 text-xs text-center sm:text-sm md:text-base lg:text-start w-3/4">
          Let's get started with some account setup! And delicious food will be on your way!
        </p>
        ...
        <div className="flex flex-row items-center sm:justify-between pt-5 w-full md:w-3/4 md:mt-2 md:mb-2">
          ...
          <Link href={"/forgot-password"}
                className="text-green-500 hover:underline hover:text-green-700 text-xs md:text-base ml-3 sm:ml-0">Forgot
            Password?</Link>
        </div>
        ...
        <p className="text-slate-600 pt-2 text-sm md:text-base md:mt-2">Don't have an Account?<Link
          className="text-green-500 ml-2 font-bold hover:text-green-600 hover:underline text-sm md:text-base"
