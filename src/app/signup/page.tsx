...
const SignupPage = () => {
  ...
  return (
    <section className='w-full h-screen flex flex-col md:flex-row bg-white'>
        ...
        <h1 className='text-white font-bold first-letter text-base md:text-xl lg:text-2xl xl:text-3xl z-10  text-center'>Taste the Convenience: Sign Up </h1>
<h1 className='text-white font-bold first-letter text-base md:text-xl lg:text-2xl xl:text-3xl z-10 text-center'>For Flavor at Your Door!</h1>
        ...
        <div className='w-full lg:w-1/2 h-full flex flex-col p-10 text-white items-center lg:items-start lg:pt-10 lg:ml-10 justify-center bg-white'>            <div className='items-start justify-start mt-10 -mb-8 md:-ml-4 md:-mb-6'>
            <Image
            ...
            <p className='text-slate-600 text-sm md:text-base pt-2 text-center lg:text-start'>Already have an account?<Link className='text-green-500 ml-2 font-bold hover:text-green-600' href={'/login'}>Sign In</Link></p>
...
<label htmlFor="email" className="block mb-2 text-sm font-medium lg:text-base text-slate-400 mt-4">
        ...
        <div className='flex flex-row items-center mt-10 lg:mt-20  '>
          ...
          <label htmlFor='agree-terms' className='text-slate-500 md:text-base text-xs ml-2'>
            I agree to{' '}
            <Link href={'/Terms'} className='text-green-500 md:text-base font-semibold text-xs font-semi hover:underline  hover:text-green-600'>
            Terms <span className='text-slate-400 text-xs md:text-base'>&</span> Policies
            </Link>
        ...
        <div className='flex flex-row sm:flex-row items-center justify-center lg:justify-start sm:justify-center mt-4 md:pt-10 md:-ml-2 xl:ml-0 md:items-center flex-wrap md:flex-nowrap md:mt-auto lg:w-3/4'>
          <h1 className='text-slate-500 text-xs md:text-sm md:mr-1 lg:mr-2 cursor-pointer hover:underline font-bold' onClick={() => {onSignup}}>Having issue?</h1>
